...
MSYS2_COMPILER_X64_BASE="$MSYS2_BASE/ucrt64"
MSYS2_COMPILER_X32_BASE="$MSYS2_BASE/mingw32"
MSYS2_COMPILER_VERSION="1520"
MSYS2_CLANG_VERSION="1507CLANG"

CB_NIGHTLY_COMPILER_BASE=/C/GreenApps/winlibs-x86_64-posix-seh-gcc-14.1.0-mingw-w64ucrt-11.0.1-r1/mingw64
...
WXWIDGETS_2_8_REPO="C:/devel/wxwidgets_libs/repos/wxWidgets_2_8_branch"
WXWIDGETS_2_8_PROD_BRANCH="wxwidgets2.8.12_git"

WXWIDGETS_3_2_REPO="C:/devel/repos/wxwidgets_libs/wxWidgets_3_2_branch"
